  ...
  <div class="login_container">
    <div class="rating-page">
      ...
      <div class="deal-wrapper">
        ...
        <div>
          我已阅读并同意
          <router-link :to="{ path: '/micro/deal/1' }">《借条借钱花注册协议》</router-link>
      ...
      <micro-footer-msg style="margin-top: .2rem"></micro-footer-msg>
    </div>
  </div>
</template>
<script>
...
import { toLogin } from "@/service/mcGetData";
import { Indicator } from "mint-ui";
export default {
  data() {
    return {
      logo: require("@/assets/micro_app_logo.png"),
      selectedTab: 0,
      timer: null,
      count: 59,
      btnText: "发送验证码",
