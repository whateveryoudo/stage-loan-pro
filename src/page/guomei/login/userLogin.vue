  ...
  <div class="login_container">
    <div class="rating-page">
      ...
      <div class="deal-wrapper">
        ...
        <div>
          我已阅读并接受
          <router-link :to="{ path: '/guoMei/deal/1' }">《国美易卡服务协议》</router-link>
          <router-link :to="{ path: '/guoMei/deal/2' }">《国美易卡隐私权政策》</router-link>
        </div>
      </div>
...
<script>
import LoginBtn from "@/components/guomei/LoginBtn";
