 ...
 * @LastEditTime: 2023-08-24 21:27:54
...
<template>
  <div class="deal-container">
    <div class="deal-page" v-show="dealType === 1">
      ...
      >
        【海南德花小额贷款有限公司】（以下简称“公司”或“本公司”）合法运营的“<span
          class="tu"
          >【贷款】</span
    ...
    <div class="deal-page" v-show="dealType === 2">
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        【贷款】非常重视用户个人信息和隐私权的保护，鉴于此，我们根据相关法律法规规定，制定本隐私权政策，帮助您了解我们将如何收集、使用并保护您的个人信息。本隐私权政策适用于我们提供的产品或服务，请您在使用我们的产品或服务前认真阅读并确认充分理解本隐私权政策，以便您做出您认为适当的选择。<span
          class="fb"
          style="font-weight:bold;"
          >您使用我们提供的产品或服务，</span
        >即意味着您已阅读本隐私权政策所有条款，并对本隐私权政策条款的含义及相应的法律后果已全部通晓并充分理解，<span
          class="fb"
          style="font-weight:bold;"
          >并且同意我们按照本隐私权政策收集、使用并保护您的个人信息。如果您不同意本隐私权政策的部分或全部内容、或对本隐私权政策内容有任何疑问，您应立即停止使用我们提供的产品或服务，并通过【贷款】客服与我们联系。</span
        >
      </p>
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        需要特别说明的是，【贷款】平台也可能含有到其他网站的链接，我们对该等链接网站的信息保护措施不负责任。我们建议您查看该等网站的隐私权政策，以了解他们如何处理您的信息，以便审慎决策。
      </p>
      <p
        class="fb"
        style='font-size:15px;font-weight:bold;color:rgba(0, 0, 0, 0.9);font-family:"'
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        <span class="j2">1.1</span>&nbsp;&nbsp;&nbsp;
        当您注册【贷款】账号时，我们将收集您的真实姓名、手机号码、身份证件号码、电子邮箱、登录密码、手势密码或面部特征等个人生物识别信息，收集此类信息是为了满足相关法律法规的网络实名制要求并保护您的账号安全。如果您仅需使用基础浏览服务，您可以选择不进行注册及提供上述信息。
      </p>
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        <span class="j2">1.2</span>&nbsp;&nbsp;&nbsp;
      ...
      >
        ...
        您的通讯录、通话详单，您的亲戚朋友、联系人及其手机号码，请您确保您在向我们提供该信息时已经获得您的亲戚朋友、联系人的同意，以便我们、我们的关联方或合作方可以通过您提供的联系方式进行联系。如您向我们提供的亲戚朋友、联系人及其手机号码的行为未经过其本人同意，我们与您的亲戚朋友、联系人进行联系所发生的风险及责任将由您承担。<span
          class="fb"
          style="font-weight:bold;"
          >当您违反与【贷款】的约定时，为维护【贷款】的合法权益，您同意【贷款】可向与【贷款】合作的律师事务所、催收机构，及【贷款】认为可向您传达信息的亲戚朋友、联系人等披露您的违约信息；若【贷款】与您的亲戚朋友、联系人等关联方存在纠纷未能协商解决的，【贷款】可能会自行或通过催收机构、律师事务所、法院、仲裁委员会和其他有权机关与您联系，请您帮助【贷款】或上述机构向您的亲戚朋友、联系人等关联方转达相关诉求，上述转达以您自愿为基础，并不会让您承担额外的法律义务或责任；</span
        >以及
      </p>
      <p
        class="t2"
      ...
      >
        vii
        有针对性地向您推荐我们提供的商品、服务或推广活动，以及与我们的关联方、合作方共享，以向您提供或推荐我们的关联方、合作方的商品、服务或推广活动。您同意我们、我们的关联方及合作方通过站内信、电子邮件、电话、短信等方式向您提供、发送服务状态的通知、营销活动及其他商业性信息。如不需要我们推广相关信息，您可联系【贷款】客服取消、退订该类信息推广服务；以及
      </p>
      <p
        class="fb t2"
        style='font-size:15px;font-weight:bold;text-indent:2em;color:rgba(0, 0, 0, 0.9);font-family:"'
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        <span class="j2">4.2</span>&nbsp;&nbsp;&nbsp;
        尽管我们采取了上述技术安全措施，但请您理解，在互联网行业由于技术的限制和飞速发展以及可能存在的各种恶意攻击手段，即便我们竭尽所能加强安全措施，也不可能始终保证信息的百分之百安全。请您了解，您使用我们的产品和/或服务时所用的系统和通讯网络，有可能因超出我们的控制能力之外的其他因素而出现安全问题。如您发现自己的个人信息泄密，尤其是您的账户或密码发生泄漏，您应该立即通过【贷款】客服与我们取得联系，以便我们采取相应措施。
      </p>
      <p
        class="fb"
        style='font-size:15px;font-weight:bold;color:rgba(0, 0, 0, 0.9);font-family:"'
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        除法律法规规定的例外情况，无论您何时使用我们的服务，我们都会力求让您顺利访问自己的个人信息。<span
          class="fb"
          style="font-weight:bold;"
          >如果您希望访问或编辑您账户中的个人资料信息（包括但不限于手机号码、电子邮箱、登录密码、手势密码、银行账户信息等），您可以在网页端或APP端中执行此类操作，或联系【贷款】客服进行编辑；</span
        >
      </p>
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        您可以通过拨打【贷款】平台上公布的【贷款】客服电话申请注销您的账户，一旦您注销账户，我们将停止为您提供服务，因此请您谨慎操作。但<span
          class="fb"
          style="font-weight:bold;"
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        如果您无法通过上述方式访问、更正或撤销您的个人信息，或者您无法完成账户注销，或者您就我们收集、使用您信息存在任何疑问，您都可以通过【贷款】客服与我们联系。为保障安全，我们可能需要您提供书面请求，或以其他方式证明您的身份。我们将在收到您的反馈并验证您身份后尽快答复您的相关请求。
      </p>
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        <span class="j2">7.1</span>&nbsp;&nbsp;&nbsp; 【贷款】客服
      </p>
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        如果您对本隐私权政策有任何疑问、意见或建议，或您在使用我们提供的服务时，就您的个人信息的收集、使用、共享、访问、更正、撤销等相关事宜有任何意见或建议，或您在使用我们提供的服务时遇到任何问题，您都可以通过【贷款】平台上公布的客服电话（400-0856-608）与我们联系。
      </p>
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
      ...
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        如本隐私权政策与【贷款】所运营的任何平台的用户注册/服务协议中规定的个人信息保护条款存在不一致或矛盾之处，请以本隐私权政策的条款为准。
      </p>
      <p style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        <br />
      </p>
      ...
      <ul style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        <li>
          <span class="fb" style="font-weight:bold;">【贷款】</span>或<span
            class="fb"
            style="font-weight:bold;"
            >我们</span
          >是指【海南德花小额贷款有限公司】及其关联方的单称或合称，【贷款】平台是指【海南德花小额贷款有限公司】运营的包括但不限于网页端、APP端的任何平台。<span
            class="fb"
            style="font-weight:bold;"
            >关联方</span
      ...
      <ul style='font-size:15px;color:rgba(0, 0, 0, 0.9);font-family:"'>
        <li>
          ...
          >是指可用于使用【贷款】产品和/或服务的装置，例如桌面设备、平板电脑或智能手机等。
        </li>
      </ul>
    </div>
  </div>
